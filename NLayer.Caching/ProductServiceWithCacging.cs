...
{
    public class ProductServiceWithCacging : IProductService
    {
        ...
        public ProductServiceWithCacging(IMapper mapper, IMemoryCache memoryCache, IProductRepository repository, IUnitOfWork unitOfWork)
        {
            _mapper = mapper;
        ...
        public Task<Product> AnyAsync(Expression<Func<Product, bool>> expression)
        {
        ...
        Task IService<Product>.AddRangeAsync(IEnumerable<Product> entities)
        {
            throw new NotImplementedException();
        }
    }
